...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/audio/mixer_paths_mtp_eu.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_eu.xml \
    $(LOCAL_PATH)/audio/mixer_paths_mtp_noeu.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_mtp_noeu.xml \
...
# Power
PRODUCT_PACKAGES += \
    android.hardware.power@1.3-service.asus-libperfmgr \
    android.hardware.power.stats@1.0-service.asus
